...
import example.com.lenovo.tripbook.bean.User;
import example.com.lenovo.tripbook.bean.UserClickSpan;
...
public class DynamicItemView {
	...
	private void find() {
		...
		picImg = (ImageButton) view.findViewById(R.id.dynamic_item_content_pic_img);
